...
for ep_num in range(1,167+1):
    ...
    save_mp3(tag=f"audio_{max_sim_start_idx}", audio_file=audio_file2, start_index=max_sim_start_idx, end_index=max_sim_end_idx, sr1=sampling_rate, sr2=sampling_rate_final)
